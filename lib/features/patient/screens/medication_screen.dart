  ...
  // ════════════════════════════════════════════════════
    Future<void> _saveMedication(List<TimeOfDay> reminders) async {
      ...
      try {
        ...
        print('Medication inserted: $medResponse');
        ...
        for (final time in reminders) {
          ...
          print('Inserting reminder: $remindAt');
          ...
          print('Reminder inserted: $reminderResponse');
...
Future<void> _deleteMedication(int medId) async {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _field(context, _nameCtrl, 'Medication name',
                ...
                TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.repeat_rounded, size: 20, color: colors.primary),
                        filled: true,
  ...
  Widget _medCard(BuildContext context, _Medication med) {
    final colors = context.colors;
  ...
  void _confirmDelete(BuildContext context, _Medication med) {
    final colors = context.colors;
    showDialog(
      context: context,
