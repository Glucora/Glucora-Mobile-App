...
class _CalorieLogScreenState extends ConsumerState<CalorieLogScreen> {
  ...
  Future<void> _init() async {
    await ref.read(foodLogProvider.notifier).load();
  }
  ...
  Future<void> _addEntry() async {
    ...
    try {
      await ref.read(foodLogProvider.notifier).insert(
        name: name,
        calories: cal,
        carbsG: carbs,
        proteinG: protein,
  ...
  Future<void> _deleteEntry(BuildContext ctx, FoodEntry entry) async {
    ...
    await ref.read(foodLogProvider.notifier).delete(entry.id!);
        ...
        children: [
          ...
          Expanded(
            child: state.isLoading
                ...
                : RefreshIndicator(
                    onRefresh: () => ref.read(foodLogProvider.notifier).load(),
                    child: SingleChildScrollView(
