        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.04), blurRadius: 8, offset: const Offset(0, 2))],//try commenting this line after it launches and see the difference in UI (shadow effect
            ),
            child: Row(
              children: [
                Container(
  ...
  // ── Patient-only settings cards ───────────────────────
          extraSettingsWidgets: [
            SettingsNavigationTile(
              ...
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const BluetoothPairingScreen(),)),
            ),
