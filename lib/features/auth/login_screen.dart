        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Email field with prefix icon and rounded corners
              TextFormField(
              ...
              // Password field with prefix icon, eye toggle, and rounded corners
              TextFormField(
              ...
              const SizedBox(height: 16),
              // Social buttons (placeholders) with rounded corners
              OutlinedButton.icon(
                onPressed: () {},
